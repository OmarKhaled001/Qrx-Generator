...
<div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
    <div class="d-flex align-items-center bg-primary bg-gradient p-3 offcanvas-header">
        <div class="me-2">
            <h5 class="mb-1 text-white">Steex assets-dashboarder</h5>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme01">
                                <img src="{{asset('assets-dashboard/images/custom-theme/light-mode.png')}}" alt="" class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme02">
                                <img src="{{asset('assets-dashboard/images/custom-theme/material.png')}}" alt="" class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme03">
                                <img src="{{asset('assets-dashboard/images/custom-theme/creative.png')}}" alt="" class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme04">
                                <img src="{{asset('assets-dashboard/images/custom-theme/minimal.png')}}" alt="" class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme05">
                                <img src="{{asset('assets-dashboard/images/custom-theme/modern.png')}}" alt="" class="img-fluid">
                            </label>
                        </div>
                    ...
                    <div class="col-6">
                        <div class="form-check card-radio">
                            ...
                            <label class="form-check-label p-0" for="customizer-theme06">
                                <img src="{{asset('assets-dashboard/images/custom-theme/interaction.png')}}" alt="" class="img-fluid">
                            </label>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-check card-radio dark">
                                ...
                                <label class="form-check-label p-0 bg-transparent" for="layout-mode-dark">
                                    <img src="{{asset('assets-dashboard/images/custom-theme/dark-mode.png')}}" alt="" class="img-fluid">
                                </label>
                            </div>
                    ...
                    <div class="d-flex gap-2 flex-wrap img-switch">
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                <img src="{{asset('assets-dashboard/images/sidebar/img-sm-1.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                        ...
                        <div class="form-check sidebar-setting card-radio">
                            ...
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                <img src="{{asset('assets-dashboard/images/sidebar/img-sm-2.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                <img src="{{asset('assets-dashboard/images/sidebar/img-sm-3.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                        <div class="form-check sidebar-setting card-radio">
                            <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                            <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                <img src="{{asset('assets-dashboard/images/sidebar/img-sm-4.jpg')}}" alt="" class="avatar-md w-auto object-cover">
                            </label>
                        </div>
                    </div>
                </div>
