    ...
    <div class="col-xl-6 col-sm-12">
        <div class="card overflow-hidden">
            <div class="card-body">
                ...
                <p class="text-muted mb-4">Total count of days :({{$totalDays-$countDay}} / {{$totalDays}} day) </p>
                <p class="text-muted mb-0"><span class="badge bg-success-subtle text-success">expire at : {{$endDate}}</span> </p>
            </div>
            <div class="progress progress-sm rounded-0" role="progressbar" aria-valuenow="{{$countDay}}" aria-valuemin="0" aria-valuemax="100">
                <div class="progress-bar bg-warning" style="width: {{$totalDays*100}}%"></div>
            </div>
        </div>
    </div>
</div>