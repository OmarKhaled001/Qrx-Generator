...
<a class="btn btn-success h1 text-center mt-5" target="_blank" href="WIFI:S:{{$qrxCode->wifi->wireless_ssid}};T:{{$qrxCode->wifi->encryption}};P:{{$qrxCode->wifi->password}};;" >Connect</a>
@endif