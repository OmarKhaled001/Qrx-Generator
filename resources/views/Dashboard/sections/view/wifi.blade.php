...
<a class="btn btn-success h1 text-center mt-5" href="wifi:ssid={{$qrxCode->wifi->wireless_ssid}}?&encryption={{$qrxCode->wifi->encryption}}?&password={{$qrxCode->wifi->password}}?&H=false" >Connect</a>
@endif